...
try {    console.log(blockLet);  // This will fail (error)
}catch (error){console.log("`blockLet` is not accessible outside the block.");
}
try {console.log(blockConst);  // This will fail (error)
}catch (error){console.log("`blockConst` is not accessible outside the block.");
}
