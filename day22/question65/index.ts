...
function remainder(num1: number, num2:number): number{  // This function finds the leftover of dividing two numbers
     return num1%num2 }  // Gives back the leftover of num1 divided by num2
