...
function muliplyDecimals(num1:number, num2:number):number{  // This function multiplies two decimal numbers
    return Math.round((num1*num2)*100)/100;  }; // Multiplies the numbers and rounds the result to two decimal places
