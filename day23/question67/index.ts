...
function addNumberAndString(number1:number, numberString: string):number{ // This function adds a number and a string that represents a number
return number1 + Number(numberString);} // Coverts the string to a number and adds it to the first number
