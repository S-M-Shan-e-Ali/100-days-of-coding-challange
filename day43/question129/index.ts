/*  Question : 129
        ...
        Explain & TIP : In traditional functions, this refers to the object that called th function, which can vary depending on the context. In arrow functions, this is lexically bound, meaning it uses this from the code that contains the arrow function.
*/
